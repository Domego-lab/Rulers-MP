...
country = {
	...
	MAX_RESEARCH_POINTS = 250000, -- max RP you can store for uncivs
},

economy = {
	MAX_DAILY_RESEARCH		    = 90000,
...
diplomacy = {
	...
	DECREASERELATION_RELATION_ON_ACCEPT = -20,
	...
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 2.0, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
	...
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.5, -- Bonus to neighbouring countries when influencing
